  ...
  <div class="user-activity">
    <div class="post">
      <div class="user-block">
        ...
        <span class="description">公开分享 - 今天晚上7:30</span>
      </div>
      <p>
        Lorem ipsum
        代表了设计师和排版专家的一个长期传统。虽然有人讨厌它并主张废除它，
        但其他人忽视这种批评，继续创造出优秀的工具，为从培根爱好者到查理·辛粉丝的所有人
        提供填充文本。
      </p>
    ...
    <div class="post">
      <div class="user-block">
        ...
        <span class="description">给你发送了一条消息 - 昨天 10:30</span>
      </div>
      <p>
        Lorem ipsum
        代表了设计师和排版专家的一个长期传统。虽然有人讨厌它并主张废除它，
    ...
    <div class="post">
      <div class="user-block">
        ...
        <span class="description">发布了4张照片 - 2天前</span>
      </div>
