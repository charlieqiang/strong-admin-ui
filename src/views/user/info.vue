<template>
    <div class="app-container">
        ...
        <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
            ...
            <el-table-column label="账号" prop="account" sortable="custom" align="center">
        ...
        <el-dialog :visible.sync="dialogVisible" :title="dialogType === 'edit' ? '编辑用户' : '新增用户'">
            <el-form :model="user" label-width="80px" label-position="left">
                ...
                <el-form-item label="角色">
                    <el-select v-model="user.roleIdList" placeholder="请选择角色" @visible-change="handleRoleDropdown"
                        :loading="roleLoading" loading-text="加载中..." multiple>
